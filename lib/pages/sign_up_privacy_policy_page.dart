...
import 'package:we_chat_app/pages/security_verification_page.dart';
...
class SignUpPrivacyPolicyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    print("Name: $name, Phone: $phone, Password: $password, Image File: $imageFile.............");
        ...
        child: Stack(
          children: [
            ...
            Align(
              ...
              child: AcceptTermsAndPolicySectionView(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
...
class AcceptTermsAndPolicySectionView extends StatefulWidget {

  final Function onTap;


  AcceptTermsAndPolicySectionView({required this.onTap});

  @override
  State<AcceptTermsAndPolicySectionView> createState() =>
      _AcceptTermsAndPolicySectionViewState();
}

class _AcceptTermsAndPolicySectionViewState
    extends State<AcceptTermsAndPolicySectionView> {
  bool isChecked = false;

  @override
  Widget build(BuildContext context) {
    return Container(
      color: Color.fromRGBO(27, 25, 28, 1.0),
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          content,
          style:
              TextStyle(color: Color.fromRGBO(255, 255, 255, 0.6), height: 1.3),
        ),
      ],
    );
  }
